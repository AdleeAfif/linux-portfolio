...
export class Terminal extends Component {
  constructor() {
    ...
    this.child_directories = {
      ...
      educations: [
        ...
        "TalentLab Backend Bootcamp",
      ],
      hobbies: ["Reading", "Watching Movies", "Playing Games", "Coding"],
      skills: [
        "Backend Development",
        "Node.js",
        "Express.js",
      ...
      projects: [
        "Linux Portfolio",
        "Personal Developer Profile API",
        "AI Engine App",
  ...
  handleCommands = (command, rowId) => {
    ...
    switch (main) {
      ...
      case "code":
        if (words[0] === "." || words.length === 0) {
          ...
          result =
            "Command '" +
            main +
            "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-adlee, todoist, trash, settings, sendmsg]";
        }
        break;
      case "echo":
      ...
      case "about-adlee":
        if (words[0] === "." || words.length === 0) {
          this.props.openApp("about-adlee");
        } else {
          result =
            "Command '" +
            main +
      ...
      case "sudo":
        ...
        result =
          "<img class=' w-2/5' src='./images/memes/pengu-linux-meme.jpeg' />";
        break;
      default:
        result =
          "Command '" +
